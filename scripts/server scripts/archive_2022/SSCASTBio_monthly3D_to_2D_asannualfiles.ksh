...
# GO 2021-02-03 - 
# Processes SalishSea 3D biology fields (monthly averages in annual .NC files)
# downloaded from https://salishsea.eos.ubc.ca/erddap/griddap/ubcSSg3DBiologyFields1moV19-05.html
# converts to 2D using climate data operator vertmean func (optional to apply to selected layers only)

pathin="/project/6006412/goldford/data/evaluation/SalishSeaCastBiology/originalmonthly3D/"
pathout="/project/6006412/goldford/data/evaluation/SalishSeaCastBiology/depthint2D/"
...
for y in {${year_start}..${year_end}} ; do 
  ...
  for file in ${pathin}ubcSSg3DBiologyFields1moV19-05_DiatomsFlagellates_${y}.nc; do
    ...
    echo calculating vertsum;
    #cdo sellevel,0.500000298,1.5000031,2.50001144,3.50003052,4.50007057,5.50015068,6.50031042,7.50062323,8.50123596,9.50243282,10.5047655 ${file} ${pathtemp}ubcSSg2DBiologyFields1moV19-05_DiatomsFlagellates_${y}_temp.nc ; 
    
    cdo vertsum ${file} ${pathout}ubcSSg2DBiologyFields1moV19-05_DiatomsFlagellates_${y}.nc ;
