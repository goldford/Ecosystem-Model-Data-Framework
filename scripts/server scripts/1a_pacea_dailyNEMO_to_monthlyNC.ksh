...
# processes NEMO NC daily outputs stored in monthly to monthly NC files
# specific processing for the pacea data repo
...
for y in $yrs ; do
  ...
  for m in $mos ; do 
    for grid in "${grids3D[@]}" ; do
      ...
      cdo monmin ${pathin}SalishSea1500-RUN${modelrun}_1d_grid_${grid}_y${y}m${m}.nc ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyMin_grid_${grid}_y${y}m${m}.nc ;
      cdo monmax ${pathin}SalishSea1500-RUN${modelrun}_1d_grid_${grid}_y${y}m${m}.nc ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyMax_grid_${grid}_y${y}m${m}.nc ;
      cdo monstd ${pathin}SalishSea1500-RUN${modelrun}_1d_grid_${grid}_y${y}m${m}.nc ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyStd_grid_${grid}_y${y}m${m}.nc ;
    done
  done
# saving code but not using it yet
  #for grid in "${grids3D[@]}" ; do
    ...
    #ncrcat ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyMin_grid_${grid}_y${y}* ${pathout_yr}SalishSea1500-RUN${modelrun}_MonthlyMin_grid_${grid}_y${y}.nc ;
    #ncrcat ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyMax_grid_${grid}_y${y}* ${pathout_yr}SalishSea1500-RUN${modelrun}_MonthlyMax_grid_${grid}_y${y}.nc ;
    #ncrcat ${pathout_mo}SalishSea1500-RUN${modelrun}_MonthlyStd_grid_${grid}_y${y}* ${pathout_yr}SalishSea1500-RUN${modelrun}_MonthlyStd_grid_${grid}_y${y}.nc ;
  #done
done
