...
plt.tight_layout()
plt.savefig('..//figs//' + model_run + '_Diatoms_Monthly_QU39_vs_Ecospace_vs_SSC_2016_2018.png')
plt.show()
...
plt.tight_layout()
plt.savefig('..//figs//' + model_run + '_Diatoms_Monthly_QU39_vs_Ecospace_2016_2018.png')
plt.show()
...
plt.tight_layout()
plt.savefig('..//figs//' + plot_label + "_" + model_run + '_Monthly_QU39_vs_Ecospace_2016_2018.png')
plt.show()
...
plt.legend(title='Taxonomic Class')
plt.grid(True)
plt.savefig('..//figs//' + 'Histo_' + model_run + '_Diatoms_PP_SSCDIA_2016_2019.png')
plt.show()
