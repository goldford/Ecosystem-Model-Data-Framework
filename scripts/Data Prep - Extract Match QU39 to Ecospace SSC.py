...
pathfile_QU39_out = r'C:\Users\Greig\Sync\6. SSMSP Model\Model Greig\Data\28. Phytoplankton\Phyto Concent del Bel Belluz 2024 2016 - 2019\MODIFIED\QU39_joined_matchtoEcospace.csv'
pathfile_QU39_out2 = r'C:\Users\Greig\Sync\6. SSMSP Model\Model Greig\Data\28. Phytoplankton\Phyto Concent del Bel Belluz 2024 2016 - 2019\MODIFIED\QU39_joined_matchtoEcospaceAndSSC.csv'
...
if do_ecospace_matching:
    ...
    QU39_df.to_csv(pathfile_QU39_out, index=False)

else:
    pd.read_csv(pathfile_QU39_out, sep=',', engine='python')
    # necessary?
    QU39_df['DateTime'] = pd.to_datetime(QU39_df['DateTime'], format='%Y-%m-%d %H:%M:%SZ')
...
if match_ssc:
    ...
    QU39_df.to_csv(pathfile_QU39_out2, index=False)
else:
    pd.read_csv(pathfile_QU39_out2, sep=',', engine='python')
    # necessary?
    QU39_df['DateTime'] = pd.to_datetime(QU39_df['DateTime'], format='%Y-%m-%d %H:%M:%SZ')
